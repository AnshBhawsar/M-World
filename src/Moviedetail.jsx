 ...
 const {pathname} = useLocation();
   ...
   overflowY:'auto',}} className="md" >
    ...
    <div className="tlq">
       ...
       <small className="sol">({info.detail.release_date.split("-")[0]})</small>
       </h1>
       <div className="xzx">
        <span className="uiop">
   ...
   <div className="cbae">
    <Horizantalcard data={(info.recommendations.length>0) ?info.recommendations:info.similar}></Horizantalcard>
   </div>
   <Outlet></Outlet>
   </div>
    </>):<Loading></Loading>
